...
import br.com.henriquegoncalves.gestao_vagas.modules.company.useCases.CreateJobUseCase;
...
public class JobController {
        ...
        @Operation(summary = "Cadastro de vaga", description = "Essa função é responsável por cadastrar vagas de empresas.")
        @ApiResponses({
